...
const $$Contact = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Contact;
  return Astro2.redirect(`/${defaultLang}/contact`);
}, "/home/thevfxeye/artdeco/src/pages/contact.astro", void 0);

const $$file = "/home/thevfxeye/artdeco/src/pages/contact.astro";
const $$url = "/contact";
