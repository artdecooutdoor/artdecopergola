...
const $$Products = createComponent(($$result, $$props, $$slots) => {
  ...
  return Astro2.redirect(`/${defaultLang}/products`);
}, "/home/thevfxeye/artdeco/src/pages/products.astro", void 0);

const $$file = "/home/thevfxeye/artdeco/src/pages/products.astro";
const $$url = "/products";
